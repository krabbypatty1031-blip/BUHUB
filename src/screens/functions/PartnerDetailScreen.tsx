  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Content */}
        <Text style={styles.content}>{partner.desc}</Text>

        {/* Meta Info */}
        <View style={styles.metaSection}>
          <View style={styles.metaRow}>
            <ClockIcon size={18} color={colors.onSurfaceVariant} />
            <Text style={styles.metaText}>{partner.time}</Text>
          </View>
          {partner.location ? (
            <View style={styles.metaRow}>
          ...
          <View style={styles.metaRow}>
            <UsersIcon size={18} color={colors.onSurfaceVariant} />
            <Text style={styles.metaText}>
              {partner.joined}/{partner.maxPeople} {t('people')} ({partner.people})
            </Text>
          </View>
        </View>
      </ScrollView>
