...
export const mockRatings: RatingsData = {
  ...
  canteen: [
    {
      id: 'canteen-hkbu-main',
      name: 'HKBU Canteen',
      department: 'Ho Sin Hang Campus',
      location: 'Ho Sin Hang Campus',
      scores: [
        { key: 'taste', label: 'taste', value: 70 },
        { key: 'hygiene', label: 'hygiene', value: 76 },
        { key: 'value', label: 'value', value: 82 },
      ],
      tags: canteenTags,
      tagCounts: buildTagCounts(canteenTags, 30),
      ratingCount: 54,
      recentCount: 16,
      scoreVariance: 7.2,
    },
    {
      id: 'canteen-hkbu-kai-tak',
      name: 'Kai Tak Campus Dining Hall',
      department: 'Kai Tak Campus',
      location: 'Kai Tak Campus',
      scores: [
        { key: 'taste', label: 'taste', value: 74 },
        { key: 'hygiene', label: 'hygiene', value: 79 },
        { key: 'value', label: 'value', value: 68 },
      ],
      tags: canteenTags,
      tagCounts: buildTagCounts(canteenTags, 22),
      ratingCount: 31,
      recentCount: 9,
      scoreVariance: 9.1,
    },
