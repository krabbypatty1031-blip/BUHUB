...
import { useErrandDetail, useDeleteErrand, useCloseErrand } from '../../hooks/useErrands';
...
export default function ErrandDetailScreen({ navigation, route }: Props) {
  ...
  const handleEnd = useCallback(() => {
    ...
    Alert.alert(t('endPostTitle'), t('endPostMessage'), [
      { text: t('cancel'), style: 'cancel' },
      {
        ...
        style: 'destructive',
        onPress: () => {
          closeErrandMutation.mutate(errand.id, {
  ...
  }, [errand, closeErrandMutation, showSnackbar, t]);
  ...
  const handleDelete = useCallback(() => {
    ...
    Alert.alert(t('deletePostTitle'), t('deletePostMessage'), [
      { text: t('cancel'), style: 'cancel' },
      {
        ...
        style: 'destructive',
        onPress: () => {
          deleteErrandMutation.mutate(errand.id, {
            onSuccess: () => {
  ...
  }, [errand, deleteErrandMutation, showSnackbar, t, navigation]);
